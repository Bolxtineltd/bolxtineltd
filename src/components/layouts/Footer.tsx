...
const Footer = () => {
  return (
    <footer
      className="bg-footer  bg-no-repeat bg-cover lg:pt-20 pt-10 space-y-20"
      id="footer"
    >
      <section className="wrapper grid lg:grid-cols-2 lg:gap-[4.75rem] gap-10">
        <div className="max-w-[469px] w-full text-white lg:space-y-[3.75rem] space-y-6">
          <div className="lg:space-y-8 space-y-4 lg:text-start text-center">
            <Bounce>
              <h2 className="title">
                <span className="text-[#949494] mx-3">Contact</span>{" "}
